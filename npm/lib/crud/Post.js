...
(function() {
  ...
  module.exports = Post = (function(_super) {
    ...
    Post.prototype.defaultMethod = function() {
      return 'post';
    };

    Post.prototype.defaultSteps = function() {
      return ['begin', 'input', 'create', 'save', 'output'];
    };
    ...
    Post.prototype.create = function(req, res, next) {
      var field, options, rest, self, value, _ref;
      rest = req.rest;
      self = rest.method;
    ...
    Post.prototype.output = function(req, res, next) {
      var rest;
      rest = req.rest;
      return res.json(rest.document);
    };
